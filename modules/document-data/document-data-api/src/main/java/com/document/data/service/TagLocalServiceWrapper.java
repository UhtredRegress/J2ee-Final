...
public class TagLocalServiceWrapper
	 ...
	 */
	@Override
	public com.document.data.model.Tag addTag(com.document.data.model.Tag tag) {
	 ...
	 */
	@Override
	public com.document.data.model.Tag createTag(long tagId) {
	 ...
	 */
	@Override
	public com.document.data.model.Tag deleteTag(long tagId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.document.data.model.Tag deleteTag(
		com.document.data.model.Tag tag) {
	 ...
	 */
	@Override
	public com.document.data.model.Tag getTag(long tagId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.document.data.model.Tag> getTags(
		int start, int end) {
	 ...
	 */
	@Override
	public com.document.data.model.Tag updateTag(
		com.document.data.model.Tag tag) {
	...
	public BasePersistence<?> getBasePersistence() {
		return _tagLocalService.getBasePersistence();
	}
