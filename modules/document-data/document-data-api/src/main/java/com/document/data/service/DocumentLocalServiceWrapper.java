...
public class DocumentLocalServiceWrapper
	...
	public com.document.data.model.Document addDocument(
		com.document.data.model.Document document) {
	 ...
	 */
	@Override
	public com.document.data.model.Document createDocument(long documentId) {
	 ...
	 */
	@Override
	public com.document.data.model.Document deleteDocument(
		com.document.data.model.Document document) {
	 ...
	 */
	@Override
	public com.document.data.model.Document deleteDocument(long documentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.document.data.model.Document getDocument(long documentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.document.data.model.Document> getDocuments(
		int start, int end) {
	 ...
	 */
	@Override
	public com.document.data.model.Document updateDocument(
		com.document.data.model.Document document) {
